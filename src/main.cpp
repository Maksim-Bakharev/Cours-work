...
#include "Win.cpp"
#include "Polozhenie.cpp"
#include "Loose.cpp"
#include "OuttextJ.cpp"
#include "Outtext.cpp"
#include "Ykrachenia.cpp"
#include "Zvezda.cpp"
#include "Snegovik.cpp"
...
main() {
  ...
  if (pynkt == 1) {
    printf("\nRules of the game:\n1) You task: collect all toys.\n2) Be wary of evil snowmen, they are very dangerous.\n3) Collect the necessary number of jewelry for the transition to the next level.\n4) When finding a bug, contact the creators.\n");
    LABLE4:
      printf("\n\nGO(1)?: ");
    scanf("%d", & go);
            ...
            for (int shagi = 1; shagi < 160; shagi++) {
...

              {
                if (kbhit()) {
                  ...
                  if (score == 1) {
                    setcolor(YELLOW);
                    ykrachenia(723, 300, 14, 0);
                  }
                  if (score == 2) {
                    setcolor(YELLOW);
                    ykrachenia(700, 300, 14, 0);
                  }
                  if (score == 3) {
                    setcolor(YELLOW);
                    ykrachenia(778, 300, 14, 0);
                  }
                  if (score == 4) {
                    setcolor(YELLOW);
                    ykrachenia(801, 300, 14, 0);
                  }
                  if (score == 5) {
                    setcolor(YELLOW);
                    ykrachenia(824, 300, 14, 0);
                  }
                  if (score == 6) {
                    setcolor(YELLOW);
                    ykrachenia(677, 300, 14, 0);
                  }
                  if (score == 7) {
                    setcolor(YELLOW);
                    ykrachenia(723, 280, 14, 0);
                  }
                  if (score == 8) {
                    setcolor(YELLOW);
                    ykrachenia(700, 280, 14, 0);
                  }
                  if (score == 9) {
                    setcolor(YELLOW);
                    ykrachenia(778, 280, 14, 0);
                  }
                  if (score == 10) {
                    setcolor(YELLOW);
                    ykrachenia(801, 280, 14, 0);
                  }
                  if (score == 11) {
                    setcolor(YELLOW);
                    ykrachenia(723, 260, 14, 0);
                  }
                  if (score == 12) {
                    setcolor(YELLOW);
                    ykrachenia(778, 260, 14, 0);
                  }
                  if (score > 12) {
                    setcolor(5);
                    zvezda(750, 230, 5, 5);
