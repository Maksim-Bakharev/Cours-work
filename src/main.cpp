...
main () {
    int go=0, score=0, Polochenie=0, pynkt=0, k, x, y, Yx, Yy, Stena=0, chel=4, lvl=1, Siel1,
    Siel2, Siel3, Siel4, Zx, Zy, color1, color2, END=0, Flag=0, Flag1, Knopka;
    char name[21];
    printf("Ââåäèòå èìÿ: ");
    gets(name);
    printf("\n          ÌÅÍÞ\n");    
    ...
    if (pynkt == 1) {
        printf("\nÏÐÀÂÈËÀ ÈÃÐÛ:\n");
        ptintf("1)Âàøà çàäà÷à: ñîáðàòü âñå žëî÷íûå èãðóøêè.\n");
        printf("2)Îïàñàéòåñü çëûõ ñíåãîâèêîâ, îíè î÷åíü îïàñíû.\n");
        printf("3)Ñîáåðèòå íåîáõîäèìîå êîëè÷åñòâî óðàøåíèé äëÿ ïåðåõîäà íà ñëåäóþùèé óðîâåíü.");
        printf("\n4)Ïðè îêîí÷àíèè èãðû íàæìèòå Esc.\n");
        printf("5)Ïðè íàõîæäåíèè áàãà èãðû, îáðàùàéòåñü ê ñîçäàòåëþ.");
